...
/* EVENTS */
	...
	function selectLayoutComparative() {
		console.log("I selected the comparative layout");
	...
	function selectLayoutDigitalEdition() {
		console.log("I selected the digital edition layout");
	...
	function selectLayoutBook() {
		console.log("I selected the book layout");
	...
	$(languageEnglishOrigBtn).click(function() { // ENGLISH ORIGINAL TEXT SELECTED
		...
		if( $(languageEnglishOrigBtn).attr('data-language') === 'active' ) {
			console.log("English Original text is already selected");
		}
		else if ( $(languageEnglishOrigBtn).attr('data-language') === 'inactive' ) {
			console.log("I selected English Original text");
			selectLangEnglishOrig();
			resetLanguagesOnRight();
			checkState();
		}
		else {
			console.log("ERROR, no language is selected");
			console.log($(languageEnglishOrigBtn).attr('data-language'));
		}
		return false;
	});
	$(languageEnglishNormBtn).click(function() { // ENGLISH NORMALIZED TEXT SELECTED
		...
		if( $(languageEnglishNormBtn).attr('data-language') === 'active' ) {
			console.log("English Normalized text is already selected");
		}
		else if ( $(languageEnglishNormBtn).attr('data-language') === 'inactive' ) {
			console.log("I selected English Normalized text");
			...
			console.log("ERROR, no language is selected");
			console.log($(languageEnglishNormBtn).attr('data-language'));
		}
		return false;
	});
	$(languageLatinOrigBtn).click(function() { // LATIN ORIGINAL TEXT SELECTED
		...
		if( $(languageLatinOrigBtn).attr('data-language') === 'active' ) {
			console.log("Latin Original text is already selected");
		}
		else if ( $(languageLatinOrigBtn).attr('data-language') === 'inactive' ) {
			console.log("I selected Latin Original text");
			selectLangLatinOrig();
			resetLanguagesOnRight();
			...
			console.log("ERROR, no language is selected");
			console.log($(languageLatinOrigBtn).attr('data-language'));
		}
		return false;
	});
	$(languageLatinRegBtn).click(function() { // LATIN REGULARIZED TEXT SELECTED
		...
		if( $(languageLatinRegBtn).attr('data-language') === 'active' ) {
			console.log("Latin Regularized text is already selected");
		}
		else if ( $(languageLatinRegBtn).attr('data-language') === 'inactive' ) {
			console.log("I selected Latin Regularized text");
			selectLangLatinReg();
			resetLanguagesOnRight();
			...
			console.log("ERROR, no language is selected");
			console.log($(languageLatinRegBtn).attr('data-language'));
		}
		return false;
	});
	$(languageGermanBtn).click(function() { // GERMAN TEXT SELECTED
		...
		if( $(languageGermanBtn).attr('data-language') === 'active' ) {
			console.log("German text is already selected");
		}
		else if ( $(languageGermanBtn).attr('data-language') === 'inactive' ) {
			console.log("I selected German text");
			selectLangGerman();
			resetLanguagesOnRight();
			...
			console.log("ERROR, no language is selected");
			console.log($(languageGermanBtn).attr('data-language'));
		}
		return false;
	});
	/* language selections */
...
/* FUNCTIONS */
	...
	function resetLanguagesOnRight() {
		$(singleTranslation).addClass('is-hidden'); // hide all english text in right half
		$(singleOriginal).addClass('is-hidden'); // hide all latin/german text in right half
	}
	function showDigitalEditionRight() {
		...
		$(sectionSingle).addClass('panel--right');
